...
print(simulate_paths(initial_state,n_steps, square_condition))
#print(simulate_paths(initial_state,80*n_steps, ellipse_condition)) #at 20*n_paths gives 1107 and at 40*n_paths gives 1163, seems to stabilize. Confirme with 80*n_paths which gives 1164
